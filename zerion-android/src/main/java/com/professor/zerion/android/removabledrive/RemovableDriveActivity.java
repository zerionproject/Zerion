...
import com.professor.zerion.android.fragment.FinalFragment;
import com.professor.zerion.android.removabledrive.RemovableDriveViewModel.Action;
import com.professor.zerion.android.removabledrive.TransferDataState.TaskAvailable;
...
public class RemovableDriveActivity extends ZerionActivity {
	...
	private Fragment getSuccessFragment(Action action) {
		...
		return FinalFragment.newInstance(title,
				R.drawable.ic_check_circle_outline, R.color.zerion_brand_green,
				text);
	}
