...
import static com.professor.zerion.android.util.UiUtils.MIN_DATE_RESOLUTION;

public class ZerionRecyclerView extends FrameLayout {
	...
	public ZerionRecyclerView(Context context) {
		this(context, null, 0);
	}

	public ZerionRecyclerView(Context context, @Nullable AttributeSet attrs) {
	...
	public ZerionRecyclerView(Context context, @Nullable AttributeSet attrs,
		...
		TypedArray attributes = context.obtainStyledAttributes(attrs,
				R.styleable.ZerionRecyclerView);
		isScrollingToEnd = attributes
				.getBoolean(R.styleable.ZerionRecyclerView_scrollToEnd, true);
		int drawableRes = attributes
				.getResourceId(R.styleable.ZerionRecyclerView_emptyImage, -1);
		if (drawableRes != -1) setEmptyImage(drawableRes);
		String emtpyText =
				attributes.getString(R.styleable.ZerionRecyclerView_emptyText);
		if (emtpyText != null) setEmptyText(emtpyText);
		String emtpyAction =
				attributes.getString(R.styleable.ZerionRecyclerView_emptyAction);
	...
	private void initViews() {
		View v = LayoutInflater.from(getContext()).inflate(
				R.layout.zerion_recycler_view, this, true);
