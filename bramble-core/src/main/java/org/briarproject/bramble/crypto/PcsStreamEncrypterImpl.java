...
class PcsStreamEncrypterImpl implements StreamEncrypter {
	...
	PcsStreamEncrypterImpl(OutputStream out, AuthenticatedCipher cipher,
		...
		framePlaintext = new byte[MAX_PAYLOAD_LENGTH + PCS_HEADER_MAX_SIZE];
	...
	public void writeFrame(byte[] payload, int payloadLength,
		...
		int pcsHeaderSize = sendState.isMode2() ?
				PCS_HEADER_MAX_SIZE : PCS_HEADER_MIN_SIZE;
		...
		encodePcsHeader(framePlaintext, messageNumber, prevChainLength, dhPublicKey);
