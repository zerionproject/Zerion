package com.professor.zerion.android.contact.connect;

import android.app.Activity;
import android.widget.Toast;

import com.professor.zerion.R;
import com.professor.zerion.android.util.Permission;
...
import static com.professor.zerion.android.util.Permission.GRANTED;
import static com.professor.zerion.android.util.Permission.PERMANENTLY_DENIED;
import static com.professor.zerion.android.util.Permission.SHOW_RATIONALE;
import static com.professor.zerion.android.util.Permission.UNKNOWN;
import static com.professor.zerion.android.util.PermissionUtils.gotPermission;
import static com.professor.zerion.android.util.PermissionUtils.isLocationEnabledForBt;
import static com.professor.zerion.android.util.PermissionUtils.requestBluetoothPermissions;
import static com.professor.zerion.android.util.PermissionUtils.showDenialDialog;
import static com.professor.zerion.android.util.PermissionUtils.showLocationDialog;
import static com.professor.zerion.android.util.PermissionUtils.showRationale;
import static com.professor.zerion.android.util.PermissionUtils.wasGrantedBluetoothPermissions;
