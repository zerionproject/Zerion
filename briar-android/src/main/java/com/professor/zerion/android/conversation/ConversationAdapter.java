...
import com.professor.zerion.android.util.BriarAdapter;
...
class ConversationAdapter
	...
	public void onBindViewHolder(ConversationItemViewHolder ui, int position) {
		ConversationItem item = items.get(position);
		// Disabled selection tracker - using long-press menu instead
		boolean selected = false; // tracker != null && tracker.isSelected(item.getKey());
