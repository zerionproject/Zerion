...
import static com.professor.zerion.android.reporting.CrashReportActivity.EXTRA_APP_LOGCAT;
import static com.professor.zerion.android.reporting.CrashReportActivity.EXTRA_APP_START_TIME;
import static com.professor.zerion.android.reporting.CrashReportActivity.EXTRA_INITIAL_COMMENT;
import static com.professor.zerion.android.reporting.CrashReportActivity.EXTRA_MEMORY_STATS;
import static com.professor.zerion.android.reporting.CrashReportActivity.EXTRA_THROWABLE;
...
public class UiUtils {
	...
	public static void triggerFeedback(Context ctx,
		...
		// Feedback functionality has been removed from the app
	}
	...
	public static void startDevReportActivity(Context ctx,
		...
		// Create implementation of MemoryStats interface
		...
		// Memory stats not serializable - removed
