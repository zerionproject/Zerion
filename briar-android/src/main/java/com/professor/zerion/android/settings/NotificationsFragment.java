...
public class NotificationsFragment extends PreferenceFragmentCompat {
	...
	public void onCreatePreferences(Bundle bundle, String s) {
		...
		if (SDK_INT < NOTIFICATION_CHANNEL_API) {
			...
			if (notifyVibration != null) notifyVibration.setVisible(false);
			if (notifySound != null) notifySound.setVisible(false);
		}
	}
	...
	private void setupNotificationPreference(SwitchPreferenceCompat pref,
		...
		// Skip if preference doesn't exist (e.g., removed features)
		if (pref == null) return;
