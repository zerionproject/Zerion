...
import org.briarproject.briar.api.messaging.MessagingManager.ProgressCallback;
...
import static org.briarproject.briar.messaging.MessagingConstants.MSG_KEY_MANIFEST_ID;
	...
	private AttachmentHeader storeLegacyAttachment(GroupId groupId,
		...
		try {
			...
			org.briarproject.bramble.api.data.BdfDictionary meta =
					new org.briarproject.bramble.api.data.BdfDictionary();
